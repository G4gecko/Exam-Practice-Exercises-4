...
public class PAssign08 extends Application {
    ...
    private String[] conversions = {defaultResult, altResult};
    private ObservableList<String> ob = FXCollections.observableArrayList(conversions);
